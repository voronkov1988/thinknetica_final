...
const statusDiv: Node = document.querySelector(".status-div");
const resultDiv: Node = document.querySelector(".result-div");
const modalPage: Node = document.querySelector(".modal-page");
const form: Node = document.querySelector("form.issues-form");

function getIssues(user: string, repository: string){
...
form.addEventListener("submit", (e)=>{
    ...
    const inputRepos = document.querySelector("input#repos").value;
    resultDiv.innerHTML = "";
    usersDiv.innerHTML = "";
    reposDiv.innerHTML = "";
...
function loadRepository(user: string){
...
function writeIntoRepos(perosArray) {
    perosArray.forEach(oneRepos =>{
        oneRepos.addEventListener("click", (e)=>{
            ...
            reposDiv.innerHTML = "";
            getIssues(inputUser.innerHTML, inputRepos.innerHTML);
        });
    });
}
